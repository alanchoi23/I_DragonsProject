...
$(document).ready(function()
{
			...
			[
				{
					title:"Natural",
					artist:"Bensound",
					mp3:"./resources/files/bensound-Natural.mp3",
					duration:"3:09"
				},
				{
					title:"Believer",
					artist:"Bensound",
					mp3:"./resources/files/bensound-Believer.mp3",
					duration:"3:24"
				},
				{
					title:"Thunder",
					artist:"Bensound",
					mp3:"./resources/files/bensound-Thunder.mp3",
					duration:"3:07"
				},
				{
					title:"Radioactive",
					artist:"Bensound",
					mp3:"./resources/files/bensound-Radioactive.mp3",
					duration:"3:06"
				},
				{
					title:"Warriors",
					artist:"Bensound",
					mp3:"./resources/files/bensound-Warriors.mp3",
					duration:"2:50"
				},
				{
					title:"Demons",
					artist:"Bensound",
					mp3:"./resources/files/bensound-Demons.mp3",
					duration:"2:55"
				}
			];
	...
	*/
	...
	function initSinglePlayer()
	{
		...
		swfPath: "./resources/plugins/jPlayer",
		supplied: "mp3",
